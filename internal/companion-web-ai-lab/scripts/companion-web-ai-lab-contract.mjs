...
for (const d of ["http_or_schema_rejected", "content_filtered_input", "content_filtered_output", "incomplete_truncated", "completed_empty_output", "completed_non_text_output", "completed_text"]) {

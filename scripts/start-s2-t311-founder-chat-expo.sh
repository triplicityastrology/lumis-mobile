...
PORT="${FOUNDER_CHAT_T311_EXPO_PORT:-8183}"
stop() { printf 'STOP_S2_T311_EXPO_%s\n' "$1" >&2; exit 1; }
cd "$ROOT"
...
printf 'S2_T311_FOUNDER_CHAT_EXPO_READY source_sha=%s route=polished-talk-prelogin port=%s mode=offline-fixture\n' "$HEAD" "$PORT"

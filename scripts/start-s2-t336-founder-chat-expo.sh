...
PORT="${FOUNDER_CHAT_T336_EXPO_PORT:-8201}"
stop() { printf 'STOP_S2_T336_EXPO_%s\n' "$1" >&2; exit 1; }
cd "$ROOT"
...
printf 'S2_T336_FOUNDER_CHAT_EXPO_READY source_sha=%s route=polished-talk-prelogin port=%s mode=offline-fixture live_authority=false\n' "$HEAD" "$PORT"

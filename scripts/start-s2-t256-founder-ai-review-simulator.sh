...
cd "$ROOT"
[[ "$(git branch --show-current)" == "codex/s2-t256-founder-ai-e2e-console" ]] || stop WRONG_BRANCH
...
printf 'S2_T256_FOUNDER_AI_E2E_SIMULATOR_READY source_sha=%s state=dice-founder-intake route=founder-ai-e2e-review mode=local_closed_synthetic\n' "$HEAD"

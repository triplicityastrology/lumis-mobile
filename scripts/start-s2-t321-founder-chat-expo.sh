...
PORT="${FOUNDER_CHAT_T321_EXPO_PORT:-8192}"
stop() { printf 'STOP_S2_T321_EXPO_%s\n' "$1" >&2; exit 1; }
cd "$ROOT"
...
printf 'S2_T321_FOUNDER_CHAT_EXPO_READY source_sha=%s route=polished-talk-prelogin port=%s mode=offline-fixture\n' "$HEAD" "$PORT"

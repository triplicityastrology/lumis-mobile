...
try {
  if (process.argv.length !== 3 || process.argv[2] !== "--verify") stop("ARGUMENTS_INVALID");
  ...
  if (control.runtime.postgres_image !== "public.ecr.aws/supabase/postgres:17.6.1.143" || control.runtime.runner !== "ubuntu-24.04") stop("RUNTIME_INVALID");

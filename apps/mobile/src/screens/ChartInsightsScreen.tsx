...
const styles = StyleSheet.create({
  ...
  headerTitle: { color: colors.ice, fontFamily: "Newsreader-Medium", fontSize: 26, fontWeight: "600" },
  ...
  planetGlyph: { color: colors.gold, fontFamily: "Newsreader-Medium", fontSize: 16, fontWeight: "600" },
  ...
  heroTitle: { color: colors.ice, fontFamily: "Newsreader-Medium", fontSize: 26, lineHeight: 32, textAlign: "center" },
  ...
  weatherTitle: { color: colors.ice, fontFamily: "Newsreader-Medium", fontSize: 18, fontWeight: "600" },

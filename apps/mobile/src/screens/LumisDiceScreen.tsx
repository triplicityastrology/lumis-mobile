...
const styles = StyleSheet.create({
  ...
  title: { color: colors.ice, fontFamily: "Newsreader-Medium", fontSize: 29, lineHeight: 36 },
  ...
  shakeTitle: { color: colors.ice, fontFamily: "Newsreader-Medium", fontSize: 28, marginBottom: 14 },
  ...
  resultTitle: { color: colors.ice, fontFamily: "Newsreader-Medium", fontSize: 23, lineHeight: 30 },
  ...
  reflectQuestion: { color: colors.ice, fontFamily: "Newsreader-Medium", fontSize: 16, lineHeight: 23, marginTop: 7 },
  ...
  octaGlyph: { color: colors.goldLight, fontFamily: "Newsreader-Medium", fontWeight: "700", position: "absolute", textAlign: "center", width: "70%" }
});

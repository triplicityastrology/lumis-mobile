...
const styles = StyleSheet.create({
  ...
  title: { color: colors.ice, fontFamily: "Newsreader-Medium", fontSize: 23 },
  ...
  avatarText: { color: colors.navy950, fontFamily: "Newsreader-Medium", fontSize: 25 },
  heroCopy: { flex: 1, minWidth: 0, gap: 7 },
  name: { color: colors.ice, fontFamily: "Newsreader-Medium", fontSize: 24 },

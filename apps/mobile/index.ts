...
import FounderPolishedChatExperience from "./src/dev/FounderPolishedChatExperience";
...
const FOUNDER_POLISHED_CHAT_ENABLED =
  __DEV__ && process.env.EXPO_PUBLIC_FOUNDER_POLISHED_CHAT === "1";
...
function Root() {
  const app = FOUNDER_POLISHED_CHAT_ENABLED
    ? createElement(FounderPolishedChatExperience)
    : FOUNDER_COMPANION_CHAT_ENABLED

# S2-T292 Dice v4 Lumis Founder decision packet
...
Lumis-Founder-signed relative window, durable single-use claim, replay rejection,
...
```text
OBTAIN_LUMIS_FOUNDER_V4_DEFAULT_OFF_DEPLOYMENT_AUTHORIZATION
```
...
After the Founder explicitly approves key creation and provides the reviewed Ed25519 SPKI checksum, generate the exact
...
matching Lumis-Founder-signed, unexpired, single-use receipt and a separate explicit

...
export type LocPlace = Readonly<{ code: string; slug: string; en: string; zh: string }>;
...
export const ELEMENT_TABLE: Readonly<Record<DiceV05Element, Readonly<{ direction: string; places: readonly LocPlace[] }>>> = Object.freeze({
  Fire: { direction: "East", places: [
    { code: "e01", slug: "heat_or_fire", en: "near heat or fire", zh: "靠近熱源或火" },
    { code: "e02", slug: "chimney", en: "chimney", zh: "煙囪" },
    { code: "e03", slug: "exterior_wall", en: "near an exterior wall", zh: "鄰近房屋圍牆" },
  ] },
  Earth: { direction: "South", places: [
    { code: "e01", slug: "road_or_ground", en: "road or ground", zh: "路面或地面" },
    { code: "e02", slug: "earth_mud_clay", en: "near earth, mud or clay", zh: "接近泥或黏土" },
    { code: "e03", slug: "basement", en: "basement", zh: "地下室" },
  ] },
  Air: { direction: "West", places: [
    { code: "e01", slug: "high_open_place", en: "a high or open place", zh: "高或視野廣闊的地方" },
    { code: "e02", slug: "upper_room_floor", en: "an upper room or floor", zh: "房屋中上層" },
    { code: "e03", slug: "roof_or_window", en: "near a roof or window", zh: "接近屋頂或窗戶" },
    { code: "e04", slug: "mountain_high_ground", en: "a mountain or high ground", zh: "高山或高地" },
    { code: "e05", slug: "off_the_floor", en: "off the floor", zh: "離開地面" },
  ] },
  Water: { direction: "North", places: [
    { code: "e01", slug: "near_water", en: "near water", zh: "靠近水" },
    { code: "e02", slug: "bathroom", en: "bathroom", zh: "浴室" },
    { code: "e03", slug: "kitchen", en: "kitchen", zh: "廚房" },
    { code: "e04", slug: "damp_place", en: "a damp place", zh: "潮濕地方" },
    { code: "e05", slug: "pool_pond_river", en: "a pool, pond or river", zh: "水池、池塘或河流" },
  ] },
});
...
export const LOCATION_PLANET_BANK: Readonly<Record<DiceV05PlanetId, LocationPlanetBank>> = Object.freeze({
  sun: { theme_en: "prominence, leadership, authority, visibility, centrality, performance, creation, recognition", theme_zh: "顯赫、領導、權威、可見、核心、表演、創造、認可",
    ...
    related: [
      { code: "p01", slug: "leader_office", en: "a leader's, manager's, owner's or senior office", zh: "領導、經理、負責人或高層的辦公室" },
      { code: "p02", slug: "executive_area", en: "an executive, administration, command or leadership area", zh: "行政、管理、指揮或領導區" },
      { code: "p03", slug: "stage", en: "a stage, theatre, performance, studio, rehearsal or presentation space", zh: "舞台、劇院、表演、工作室、排練或簡報空間" },
      { code: "p04", slug: "prominent_place", en: "a public-facing, prominent, formal, prestigious or highly visible place", zh: "對外、顯眼、正式、有名望或高度可見的地方" },
      { code: "p05", slug: "central_focus", en: "the central or focal part of a room, workplace, building or event venue", zh: "房間、工作場所、建築或活動場地的中心或焦點位置" },
      { code: "p06", slug: "reception_award", en: "a reception, ceremonial, awards, recognition or display area", zh: "接待、典禮、頒獎、表彰或陳列區" },
      { code: "p07", slug: "self_expression", en: "a place of self-expression, creation, publicity or being seen", zh: "自我表達、創作、宣傳或被看見的地方" },
      { code: "p08", slug: "home_display", en: "in a home: the main living area, home office, display shelf, trophy area or place where important items are deliberately presented", zh: "在家中：主要起居區、家居辦公室、陳列架、獎座區或刻意展示重要物品的地方" },
    ] },
  moon: { theme_en: "home, family, domestic life, care, food, nourishment, water, night, everyday household security", theme_zh: "家庭、家人、居家、照顧、食物、滋養、水、夜間、日常家居保障",
    ...
    related: [
      { code: "p01", slug: "family_home", en: "the questioner's or family home, or a family member's place", zh: "問卜者或家人的家，或家庭成員的地方" },
      { code: "p02", slug: "bedroom_private", en: "bedroom, living room, family room, nursery, child's room or private domestic area", zh: "睡房、客廳、家庭房、育嬰室、兒童房或私人居家空間" },
      { code: "p03", slug: "kitchen_food", en: "kitchen, dining, pantry, food cupboard, refrigerator area, restaurant, café, canteen or food-service", zh: "廚房、飯廳、儲物間、食物櫃、雪櫃區、餐廳、咖啡店、飯堂或供餐處" },
      { code: "p04", slug: "rest_care_place", en: "a place to rest, sleep, eat, cook, receive care or look after family", zh: "休息、睡覺、進食、煮食、受照顧或照顧家人的地方" },
      { code: "p05", slug: "near_water_domestic", en: "near water, drinks, cups, sinks, washing, the sea, boats or waterfront when supported", zh: "在有支持時：近水、飲料、杯、洗手盆、洗滌、海、船或水岸" },
      { code: "p06", slug: "caregiving_service", en: "caregiving, childcare, maternity, nursing, hospitality or domestic-service", zh: "照顧、托兒、產科、護理、款待或家務服務" },
      { code: "p07", slug: "household_storage", en: "familiar household storage chosen for safekeeping", zh: "為安全收藏而選的熟悉家居收納" },
      { code: "p08", slug: "night_routine_place", en: "a place used more at night or in a domestic routine", zh: "較常在夜間或日常家居流程使用的地方" },
    ] },
  mercury: { theme_en: "information, documents, writing, learning, communication, movement, short travel, transactions, devices", theme_zh: "資訊、文件、書寫、學習、溝通、走動、短途、交易、裝置",
    ...
    related: [
      { code: "p01", slug: "school", en: "school, classroom, tutorial room, library, bookstore, study room, training room or examination area", zh: "學校、課室、補習室、圖書館、書店、自修室、訓練室或試場" },
      { code: "p02", slug: "desk_office", en: "desk, writing table, stationery, document cabinet, filing area, mailroom, printer-copier or office communications", zh: "書桌、寫字檯、文具、文件櫃、存檔區、收發室、影印機或辦公室通訊" },
      { code: "p03", slug: "documents", en: "near books, notebooks, letters, forms, receipts, tickets, passports, identification or packaging labels", zh: "近書本、筆記、信件、表格、收據、車票、護照、證件或包裝標籤" },
      { code: "p04", slug: "devices", en: "near a phone, computer, tablet, router, charger, keyboard or comms device", zh: "近電話、電腦、平板、路由器、充電器、鍵盤或通訊裝置" },
      { code: "p05", slug: "transport", en: "bus stop, railway station, airport transit, taxi, vehicle, bicycle area, ticket counter or short-trip bag", zh: "巴士站、火車站、機場轉機、的士、車輛、單車區、售票櫃檯或短途袋" },
      { code: "p06", slug: "courier_reception", en: "courier, post office, delivery, reception counter, information desk or customer-service counter", zh: "速遞、郵局、派送、接待櫃檯、詢問處或客戶服務櫃檯" },
      { code: "p07", slug: "workspace_people", en: "a sibling's, neighbour's, student's, writer's, salesperson's or messenger's workspace", zh: "兄弟姊妹、鄰居、學生、作者、銷售員或信差的工作空間" },
      { code: "p08", slug: "small_container", en: "a small container for papers or travel items (document pouch, briefcase, laptop bag, handbag compartment or desk drawer)", zh: "存放文件或旅行物品的小容器（文件袋、公事包、手提電腦袋、手袋間格或書桌抽屜）" },
    ] },
  venus: { theme_en: "beauty, art, pleasure, harmony, shopping, adornment, relationships, music, celebration", theme_zh: "美、藝術、愉悅、和諧、購物、裝飾、關係、音樂、慶祝",
    ...
    related: [
      { code: "p01", slug: "gallery", en: "gallery, museum, art studio, craft room, design studio, music room or concert venue", zh: "畫廊、博物館、美術工作室、手作室、設計工作室、音樂室或音樂會場地" },
      { code: "p02", slug: "garden", en: "garden, flower shop, florist, landscaped area, park or decorative outdoor area", zh: "花園、花店、花藝、園景區、公園或裝飾性戶外區" },
      { code: "p03", slug: "shop", en: "shop, boutique, department store, shopping centre, gift shop, jewellery store or luxury retail", zh: "商店、精品店、百貨公司、購物中心、禮品店、珠寶店或奢侈品零售" },
      { code: "p04", slug: "salon_wardrobe", en: "beauty salon, spa, cosmetics area, dressing room, wardrobe, vanity table, jewellery box, accessory drawer or clothing storage", zh: "美容院、水療、化妝品區、更衣室、衣櫃、梳妝台、首飾盒、飾物抽屜或衣物收納" },
      { code: "p05", slug: "celebration_venue", en: "restaurant, wedding venue, celebration, date venue, lounge or pleasant social setting", zh: "餐廳、婚禮場地、慶祝、約會地點、休息廳或宜人的社交場合" },
      { code: "p06", slug: "near_beautiful_items", en: "near artwork, decoration, flowers, perfume, cosmetics, jewellery, clothing, gifts, music equipment or items chosen for beauty", zh: "近藝術品、裝飾、花、香水、化妝品、首飾、衣物、禮物、音樂器材或為美感而選的物品" },
      { code: "p07", slug: "relationship_space", en: "a partner's personal area or a shared relationship or celebration space", zh: "伴侶的私人區域，或共享的關係或慶祝空間" },
    ] },
  mars: { theme_en: "action, heat, force, competition, sport, tools, cutting, conflict, machinery, surgery", theme_zh: "行動、熱、力量、競爭、運動、工具、切割、衝突、機械、手術",
    ...
    related: [
      { code: "p01", slug: "gym", en: "gym, sports field, stadium, training area, martial-arts school, competition venue or exercise space", zh: "健身室、運動場、體育館、訓練區、武術學校、比賽場地或運動空間" },
      { code: "p02", slug: "workshop", en: "workshop, garage, repair area, mechanical room, tool room, hardware, construction or machinery area", zh: "工作坊、車房、維修區、機械房、工具房、五金、建造或機械區" },
      { code: "p03", slug: "kitchen_work", en: "a kitchen work area when knives, cutting, heat or active preparation is relevant", zh: "涉及刀具、切割、熱力或動手準備時的廚房工作區" },
      { code: "p04", slug: "surgical", en: "operating theatre, surgical, emergency or first-aid area when supported", zh: "在有支持時：手術室、外科、急症或急救區" },
      { code: "p05", slug: "near_sharp_hot", en: "near sharp tools, blades, sports equipment, engines, heating equipment or active machinery", zh: "近利器、刀刃、運動器材、引擎、加熱設備或運作中的機械" },
      { code: "p06", slug: "conflict_place", en: "a place of argument, confrontation, accident, urgent action or physical competition", zh: "爭執、對抗、意外、緊急行動或體能競賽的地方" },
      { code: "p07", slug: "security_service", en: "security, military, police, firefighting or emergency-response when supported", zh: "在有支持時：保安、軍事、警察、消防或緊急應變" },
    ] },
  jupiter: { theme_en: "higher learning, religion, law, publishing, expansion, wealth, large institutions, overseas affairs", theme_zh: "高等學習、宗教、法律、出版、擴展、財富、大型機構、海外事務",
    ...
    related: [
      { code: "p01", slug: "temple", en: "temple, church, religious institution, spiritual teaching centre or ceremonial religious place", zh: "寺廟、教堂、宗教機構、靈修教學中心或宗教禮儀場所" },
      { code: "p02", slug: "university", en: "university, college, campus, lecture hall, academic department or research-teaching institution", zh: "大學、學院、校園、演講廳、學術部門或研究教學機構" },
      { code: "p03", slug: "court_legal", en: "court, law office, legal department, immigration office, consulate, embassy or formal advisory setting", zh: "法院、律師樓、法律部門、入境處、領事館、大使館或正式顧問場所" },
      { code: "p04", slug: "publisher", en: "publisher, editorial office, printing house, library, book warehouse or large bookshop", zh: "出版社、編輯部、印刷廠、圖書館、書倉或大型書店" },
      { code: "p05", slug: "corporation", en: "large corporation, headquarters, major institution, large conference venue or expansive workplace", zh: "大企業、總部、大型機構、大型會議場地或寬敞的工作場所" },
      { code: "p06", slug: "bank_wealth", en: "bank, investment office, wealth-management, financial-advisory or a place where significant resources are managed", zh: "銀行、投資機構、財富管理、財務顧問或管理大量資源的地方" },
      { code: "p07", slug: "overseas", en: "airport, an overseas or international area, travel office or place connected to long-distance travel or immigration", zh: "機場、海外或國際區、旅遊機構或與長途旅行或入境相關的地方" },
      { code: "p08", slug: "large_public_room", en: "a large room, broad public area or place where knowledge or opportunity is expanded", zh: "大房間、寬廣的公共區域或擴展知識或機會的地方" },
    ] },
  saturn: { theme_en: "structure, labour, restriction, age, tradition, authority, planning, construction, storage, endurance", theme_zh: "結構、勞動、限制、年歲、傳統、權威、規劃、建造、儲存、堅持",
    ...
    related: [
      { code: "p01", slug: "factory_storage", en: "factory, industrial site, production floor, warehouse, storeroom, stockroom or long-term storage", zh: "工廠、工業用地、生產線、倉庫、貯物室、存貨室或長期儲存" },
      { code: "p02", slug: "farm_rural", en: "farm, agricultural land, barn, field, livestock structure or rural work area", zh: "農場、農地、穀倉、田地、牲畜建築或鄉郊工作區" },
      { code: "p03", slug: "government_records", en: "government department, public authority, regulatory office, records office or formal administrative institution", zh: "政府部門、公權力機關、監管機構、檔案處或正式行政機構" },
      { code: "p04", slug: "traditional_company", en: "traditional company, long-established workplace, conservative organisation or senior management area", zh: "傳統公司、老牌工作場所、保守機構或高級管理區" },
      { code: "p05", slug: "construction", en: "construction site, building structure, maintenance area, utility room or service shaft", zh: "建築工地、樓宇結構、維修區、機房或服務豎井" },
      { code: "p06", slug: "archive_locked", en: "archive, filing room, old records, locked cabinet, safe storage, restricted room or seldom-used space", zh: "檔案室、存檔房、舊記錄、上鎖櫃、保險收納、受限房間或甚少使用的空間" },
      { code: "p07", slug: "old_neglected", en: "an old, worn, cold, dark, dry, heavy, neglected, delayed or hard-to-access area", zh: "老舊、殘破、陰冷、黑暗、乾燥、沉重、荒廢、延誤或難以到達的區域" },
      { code: "p08", slug: "duty_confinement", en: "a place of duty, long-term work, pressure, rules, illness or confinement", zh: "職責、長期工作、壓力、規則、疾病或囚禁的地方" },
    ] },
  uranus: { theme_en: "technology, invention, experimentation, electricity, disruption, independence, unconventional systems", theme_zh: "科技、發明、實驗、電力、顛覆、獨立、非常規系統",
    ...
    related: [
      { code: "p01", slug: "tech_company", en: "technology company, startup, innovation hub, engineering office, computer lab or electronics workshop", zh: "科技公司、初創、創新中心、工程辦公室、電腦實驗室或電子工作坊" },
      { code: "p02", slug: "laboratory", en: "laboratory, testing room, prototype area, R&D facility or experimental workspace", zh: "實驗室、測試室、原型區、研發設施或實驗工作空間" },
      { code: "p03", slug: "observatory", en: "observatory, planetarium, aerospace-space setting or aviation technology area", zh: "天文台、天象館、航天太空場所或航空科技區" },
      { code: "p04", slug: "server_electrical", en: "server room, network cabinet, electrical panel, charging station, smart-device area or near electronic equipment", zh: "伺服器房、網絡櫃、電力配電盤、充電站、智能裝置區或近電子設備" },
      { code: "p05", slug: "astrology_venue", en: "astrology school, consultation room, metaphysical technology platform or astronomy venue", zh: "占星學校、諮詢室、形上學科技平台或天文場地" },
      { code: "p06", slug: "unusual_location", en: "an unusual, recently changed, temporary, unexpected, separated or non-standard location when supported", zh: "在有支持時：不尋常、近期改動、臨時、意外、分離或非標準的位置" },
    ] },
  neptune: { theme_en: "sea, spirituality, music, art, meditation, imagination, dissolution, confusion, substances", theme_zh: "海、靈性、音樂、藝術、冥想、想像、消融、迷惘、物質",
    ...
    related: [
      { code: "p01", slug: "seaside", en: "seaside, beach, harbour, boat, waterfront, poolside or water-related environment", zh: "海邊、沙灘、港口、船、水岸、泳池邊或與水相關的環境" },
      { code: "p02", slug: "chapel_retreat", en: "church, chapel, spiritual centre, meditation room, retreat, prayer room or sacred quiet place", zh: "教堂、小聖堂、靈修中心、冥想室、靜修所、祈禱室或安靜聖地" },
      { code: "p03", slug: "concert_studio", en: "concert hall, music studio, recording room, rehearsal room, cinema, theatre or artistic-creative space", zh: "音樂廳、音樂工作室、錄音室、排練室、戲院、劇場或藝術創作空間" },
      { code: "p04", slug: "divination_healing", en: "divination venue, spiritual consultation, healing-meditation or dreamwork setting", zh: "占卜場地、靈性諮詢、療癒冥想或夢境工作場所" },
      { code: "p05", slug: "near_liquids", en: "near liquids, drinks, medicine, alcohol, perfume, paint, photographic materials or a container that may leak", zh: "近液體、飲料、藥物、酒精、香水、油漆、攝影材料或可能滲漏的容器" },
      { code: "p06", slug: "misty_concealed", en: "a misty, damp, poorly marked, confusing, cluttered, concealed-by-soft-material or easily overlooked area", zh: "有霧氣、潮濕、標示不清、混亂、雜物堆積、被軟物遮蓋或容易被忽略的區域" },
      { code: "p07", slug: "pharmacy_health", en: "hospital, pharmacy, treatment area or medicine cabinet only with a direct health-substance connection", zh: "只在有直接健康或藥物關聯時：醫院、藥房、治療區或藥櫃" },
    ] },
  pluto: { theme_en: "underground, secrecy, power, crisis, deep research, confinement, destruction and renewal, hidden control", theme_zh: "地下、隱秘、權力、危機、深入研究、囚禁、破壞與更新、隱藏控制",
    ...
    related: [
      { code: "p01", slug: "basement_tunnel", en: "basement, cellar, underground level, tunnel, buried-covered area or the deepest part of storage", zh: "地下室、地窖、地下層、隧道、埋藏或被覆蓋的區域，或收納最深處" },
      { code: "p02", slug: "restricted_secure", en: "prison, detention area, restricted zone, secure facility or a place inaccessible without permission", zh: "監獄、拘留區、限制區、保安設施或未經許可不能進入的地方" },
      { code: "p03", slug: "research_confidential", en: "research institution, forensic laboratory, psychology-research room, investigation office or confidential records", zh: "研究機構、法證實驗室、心理研究室、調查辦公室或機密記錄" },
      { code: "p04", slug: "safe_concealed", en: "safe, locked box, locked drawer, secure cabinet, concealed compartment, private archive or secret storage", zh: "保險箱、上鎖盒、上鎖抽屜、保安櫃、隱藏間格、私人檔案或秘密收納" },
      { code: "p05", slug: "waste_demolition", en: "waste, disposal, recycling, renovation, demolition or contaminated area when loss-destruction is relevant", zh: "在涉及損失或破壞時：廢物、棄置、回收、翻新、拆卸或受污染的區域" },
      { code: "p06", slug: "crisis_control", en: "a place of crisis management, control systems, confidential information, birth-death services or deep transformation", zh: "危機管理、控制系統、機密資訊、生死服務或深層轉化的地方" },
      { code: "p07", slug: "behind_beneath_inside", en: "behind, beneath or inside another object when the House and context support concealment", zh: "在宮位與情境支持隱藏時：在另一物件的後方、下方或內部" },
    ] },
  north_node: { theme_en: "growth, learning, progress, new direction, future development, unfamiliar opportunity", theme_zh: "成長、學習、進步、新方向、未來發展、陌生機會",
    ...
    related: [
      { code: "p01", slug: "academy", en: "academy, school, training centre, classroom, workshop or coaching-development space", zh: "學院、學校、培訓中心、課室、工作坊或指導發展空間" },
      { code: "p02", slug: "development_venue", en: "university, educational institution, professional-development venue or a place to acquire a new skill", zh: "大學、教育機構、專業發展場地或學習新技能的地方" },
      { code: "p03", slug: "overseas_new", en: "an overseas or foreign place, immigration-travel setting, international organisation or cross-cultural environment", zh: "海外或外地、入境旅行場所、國際組織或跨文化環境" },
      { code: "p04", slug: "new_workplace", en: "a new workplace, newly opened room, new route, unfamiliar destination or next-stage place", zh: "新工作地點、新開的房間、新路線、陌生目的地或下一階段的地方" },
      { code: "p05", slug: "orientation_area", en: "an orientation area, admissions office, career-development office or place where future plans are prepared", zh: "迎新區、報名處、職業發展辦公室或準備未來計劃的地方" },
    ] },
  south_node: { theme_en: "the past, old habits, release, return, previous use, ancestry, what has been left behind", theme_zh: "過去、舊習慣、放下、回歸、曾經使用、祖源、被留下之物",
    ...
    related: [
      { code: "p01", slug: "old_home", en: "an old home, former residence, parents'-family's old home, ancestral place or childhood place", zh: "舊居、前住所、父母或家人的舊居、祖屋或童年地方" },
      { code: "p02", slug: "heritage_site", en: "a historical building, heritage site, museum-archive of old material or traditional site", zh: "歷史建築、文物古蹟、舊物博物館或檔案，或傳統場所" },
      { code: "p03", slug: "previous_workplace", en: "a previous workplace, former classroom, old shop, former route or place previously used", zh: "從前的工作地點、舊課室、舊店、舊路線或曾經使用的地方" },
      { code: "p04", slug: "old_storage", en: "storage for old belongings, inherited items, old documents, keepsakes, unused furniture or items to discard", zh: "存放舊物、承繼物品、舊文件、紀念品、閒置傢俬或待棄物品的地方" },
      { code: "p05", slug: "attic_forgotten", en: "attic, spare room, back cupboard, old box, forgotten bag, disused corner or an area not checked for a long time", zh: "閣樓、雜物房、後櫃、舊箱、被遺忘的袋、棄用角落或久未查看的區域" },
      { code: "p06", slug: "clearing_out", en: "a place of returning, reviewing, clearing out, releasing or finishing the past", zh: "回歸、回顧、清理、放下或結束過去的地方" },
    ] },
});
...
export const LOCATION_HOUSE_BANK: Readonly<Record<number, LocationHouseBank>> = Object.freeze({
  1: { setting_en: "the questioner, own space, body/person, immediate surroundings, own group/team", setting_zh: "問卜者、自己的空間、身體或本人、眼前環境、自己的群組",
    ...
    related: [
      { code: "h01", slug: "on_questioner", en: "on the questioner, in clothing, a pocket, wallet, handbag, backpack or a carried item", zh: "在問卜者身上、衣物、口袋、銀包、手袋、背包或隨身物品" },
      { code: "h02", slug: "current_room", en: "the current room, own desk, chair, bedside area, personal drawer, locker or workstation", zh: "現在的房間、自己的書桌、椅、床邊、私人抽屜、儲物櫃或工作位" },
      { code: "h03", slug: "own_controlled", en: "own home, office, vehicle, own side of a shared room or a place under the questioner's control", zh: "自己的家、辦公室、車輛、共用房間中屬於自己的一邊，或由問卜者控制的地方" },
      { code: "h04", slug: "within_reach", en: "immediately nearby, within reach, near the entrance-current position or the first place normally checked", zh: "就在附近、伸手可及、近入口或當前位置，或通常最先查看的地方" },
      { code: "h05", slug: "own_team_area", en: "a team, group or shared area directly representing the questioner", zh: "直接代表問卜者的團隊、群組或共用區域" },
    ] },
  2: { setting_en: "money, movable possessions, valuables, income, resources, personal financial support", setting_zh: "金錢、可移動財物、貴重物、收入、資源、個人財務支持",
    ...
    related: [
      { code: "h01", slug: "bank_finance", en: "bank, cash counter, finance office, payment area or safe-deposit", zh: "銀行、收銀處、財務室、付款區或保管箱" },
      { code: "h02", slug: "wallet_safe", en: "wallet, purse, cash box, safe, valuables cabinet, jewellery storage, asset file or money drawer", zh: "銀包、錢包、錢箱、保險箱、貴重物櫃、首飾收納、資產檔案或錢抽屜" },
      { code: "h03", slug: "personal_storage", en: "personal storage, wardrobe, cupboard, shelf, inventory or stock area", zh: "個人收納、衣櫃、櫥櫃、架、存貨或貨倉區" },
      { code: "h04", slug: "revenue_area", en: "a workplace area handling revenue, accounts, cash, invoices or valuables", zh: "處理收入、帳目、現金、發票或貴重物的工作區" },
      { code: "h05", slug: "supporter_resource", en: "a supporter's or ally's resource area", zh: "支持者或盟友的資源區" },
    ] },
  3: { setting_en: "communication, documents, messages, short travel, siblings, relatives, neighbours, local community", setting_zh: "溝通、文件、訊息、短途、兄弟姊妹、親戚、鄰居、本地社區",
    ...
    related: [
      { code: "h01", slug: "nearby_street", en: "a nearby street, corridor, lobby, lift area, building common area, local shop, neighbourhood or neighbour's place", zh: "附近的街道、走廊、大堂、電梯區、樓宇公共區、就近商店、街坊或鄰居的地方" },
      { code: "h02", slug: "short_transport", en: "bus stop, station, taxi, vehicle, bicycle area, parking-transport interchange or short-trip route", zh: "巴士站、車站、的士、車輛、單車區、停車或轉乘處，或短途路線" },
      { code: "h03", slug: "desk_mail", en: "desk, mailbox, post area, courier, printer, filing area, newspaper-magazine area or comms equipment", zh: "書桌、信箱、郵寄區、速遞、打印機、存檔區、報章雜誌區或通訊設備" },
      { code: "h04", slug: "local_contact", en: "a sibling's, relative's, neighbour's, colleague's or local contact's space", zh: "兄弟姊妹、親戚、鄰居、同事或本地聯絡人的空間" },
      { code: "h05", slug: "commute_bag", en: "a bag or container for commuting, errands, documents or daily communication", zh: "用於通勤、辦事、文件或日常通訊的袋或容器" },
    ] },
  4: { setting_en: "home, parents (esp. father), family, ancestors, property, land, private foundations, below-ground/hidden domestic space", setting_zh: "家、父母（尤其父親）、家人、祖先、物業、土地、私密根基、地下或隱蔽的家居空間",
    ...
    related: [
      { code: "h01", slug: "family_property", en: "the questioner's, parents', family or ancestral home or property", zh: "問卜者、父母、家人或祖先的家或物業" },
      { code: "h02", slug: "household_room", en: "bedroom, living or family room, a private household room, family storage, important-document storage or a place only household members use", zh: "睡房、客廳或家庭房、私人家居房間、家庭收納、重要文件收納，或只有家庭成員使用的地方" },
      { code: "h03", slug: "under_furniture", en: "basement, cellar, under-floor, low cupboard, bottom shelf, under furniture, inside a fixed household cabinet or a private hidden corner", zh: "地下室、地窖、地板下、矮櫃、底層、傢俬下方、固定家居櫃內或私人隱蔽角落" },
      { code: "h04", slug: "garden_land", en: "garden, yard, land, farm, soil area, attached garage or property boundary", zh: "花園、庭院、土地、農場、泥土區、附連車庫或物業邊界" },
      { code: "h05", slug: "family_records", en: "near family records, property documents, photographs, heirlooms, household archives or parents' possessions", zh: "近家庭記錄、物業文件、相片、傳家物、家居檔案或父母的物品" },
    ] },
  5: { setting_en: "entertainment, games, pleasure, sport, creativity, pregnancy, children, social enjoyment", setting_zh: "娛樂、遊戲、愉悅、運動、創作、懷孕、子女、社交享受",
    ...
    related: [
      { code: "h01", slug: "playground", en: "playground, children's room, nursery play area or school activity room", zh: "遊樂場、兒童房、育嬰遊戲區或學校活動室" },
      { code: "h02", slug: "gym_recreation", en: "gym, sports field, stadium, game room, recreation centre, club or hobby area", zh: "健身室、運動場、體育館、遊戲室、康樂中心、會所或興趣區" },
      { code: "h03", slug: "theatre_party", en: "theatre, cinema, concert venue, performance space, party venue, bar, celebration or amusement venue", zh: "劇院、戲院、音樂會場地、表演空間、派對場地、酒吧、慶祝或遊樂場地" },
      { code: "h04", slug: "craft_hobby", en: "art-craft room, music room, creative studio, hobby desk, toy storage, game storage or leisure shelf", zh: "美術手作室、音樂室、創作工作室、興趣書桌、玩具收納、遊戲收納或休閒架" },
      { code: "h05", slug: "romantic_place", en: "a romantic-date or pleasure place when directly relevant", zh: "在直接相關時：浪漫約會或享樂的地方" },
    ] },
  6: { setting_en: "work, service, employees, routine duties, illness, clinics, animals and maintenance", setting_zh: "工作、服務、員工、日常職責、疾病、診所、動物與維修",
    ...
    related: [
      { code: "h01", slug: "office_routine", en: "office, workstation, staff room, service counter, back office, operations or routine-work area", zh: "辦公室、工作位、員工室、服務櫃檯、後勤、營運或例行工作區" },
      { code: "h02", slug: "clinic", en: "clinic, medical office, treatment room, pharmacy, medicine cabinet, health-service area or sick room", zh: "診所、醫務所、治療室、藥房、藥櫃、健康服務區或病房" },
      { code: "h03", slug: "animal_area", en: "pet area, kennel, animal clinic, stable, livestock area, farm-service or animal-supply storage", zh: "寵物區、狗舍、動物診所、馬廄、牲畜區、農務服務或動物用品儲存" },
      { code: "h04", slug: "maintenance", en: "cleaning cupboard, utility area, maintenance room, laundry, staff storage or tool-supply cabinet", zh: "清潔櫃、雜物區、維修房、洗衣、員工儲存或工具用品櫃" },
      { code: "h05", slug: "employee_area", en: "an employee's, assistant's, service provider's or subordinate's work area", zh: "員工、助理、服務提供者或下屬的工作區" },
    ] },
  7: { setting_en: "another person, partner, counterpart, opponent, adviser, doctor, astrologer, or destination", setting_zh: "另一人、伴侶、對方、對手、顧問、醫生、占星師，或目的地",
    ...
    related: [
      { code: "h01", slug: "destination", en: "the intended destination, arrival point, delivery address, meeting point or place travelled to", zh: "目的地、抵達點、送遞地址、會面點或前往的地方" },
      { code: "h02", slug: "counterpart_place", en: "a partner's, spouse's, client's, customer's, adviser's, doctor's, astrologer's, opponent's or counterpart's place", zh: "伴侶、配偶、客戶、顧客、顧問、醫生、占星師、對手或對方的地方" },
      { code: "h03", slug: "meeting_room", en: "meeting room, consultation room, negotiation table, reception, contract-signing place or one-to-one space", zh: "會議室、諮詢室、談判桌、接待處、簽約地點或一對一空間" },
      { code: "h04", slug: "other_side", en: "the other side of a shared space, a place facing the questioner or an area controlled by another person", zh: "共用空間的對面、面向問卜者的地方，或由他人控制的區域" },
      { code: "h05", slug: "exchange_place", en: "a place of exchange, handover, appointment, agreement or confrontation", zh: "交換、交收、約會、協議或對質的地方" },
    ] },
  8: { setting_en: "danger, loss, decay, inheritance, partner's money, debt, loans, tax, fear, confidential financial matters", setting_zh: "危險、損失、腐朽、遺產、伴侶的金錢、債務、貸款、稅務、恐懼、機密財務",
    ...
    related: [
      { code: "h01", slug: "bank_tax", en: "bank, loan office, debt-credit department, tax office, treasury, insurance claims or financial records", zh: "銀行、貸款處、債務信貸部、稅局、庫房、保險索償或財務記錄" },
      { code: "h02", slug: "others_money", en: "a place where another's money or shared assets are kept", zh: "存放他人金錢或共享資產的地方" },
      { code: "h03", slug: "estate_archive", en: "safe, locked financial cabinet, inheritance-will file, confidential account archive or estate-document storage", zh: "保險箱、上鎖財務櫃、遺產遺囑檔案、機密帳戶檔案或遺產文件收納" },
      { code: "h04", slug: "decaying_waste", en: "a dangerous, damaged, decaying, waste, disposal, recycling, sewage or contaminated area", zh: "危險、受損、腐朽、廢物、棄置、回收、污水或受污染的區域" },
      { code: "h05", slug: "crisis_setting", en: "an emergency, crisis, mortuary-funeral or loss setting only when directly relevant", zh: "只在直接相關時：緊急、危機、殮房殯儀或損失場所" },
      { code: "h06", slug: "fear_place", en: "a place of fear or avoidance only if it also fits the physical evidence", zh: "只有在也符合物理證據時：令人恐懼或迴避的地方" },
    ] },
  9: { setting_en: "long travel, foreign places, religion, philosophy, language, higher education, law, guidance, publishing", setting_zh: "遠行、外地、宗教、哲學、語言、高等教育、法律、指導、出版",
    ...
    related: [
      { code: "h01", slug: "university_guidance", en: "university, college, lecture hall, academic library, research-teaching, language school or counselling-guidance office", zh: "大學、學院、演講廳、學術圖書館、研究教學、語言學校或輔導指導辦公室" },
      { code: "h02", slug: "publisher_knowledge", en: "publisher, editorial office, printing house, large bookstore or formal knowledge distribution", zh: "出版社、編輯部、印刷廠、大型書店或正式知識發佈" },
      { code: "h03", slug: "law_court", en: "law office, court, tribunal, legal-advice centre, government legal office or document-certification office", zh: "律師樓、法院、審裁處、法律諮詢中心、政府法律辦公室或文件認證處" },
      { code: "h04", slug: "religious_venue", en: "church, temple, monastery, religious school, spiritual-teaching venue or pilgrimage place", zh: "教堂、寺廟、修道院、宗教學校、靈修教學場地或朝聖地" },
      { code: "h05", slug: "airport_abroad", en: "airport, port, travel office, overseas destination, hotel abroad, embassy, consulate, immigration office or international organisation", zh: "機場、港口、旅遊機構、海外目的地、外地酒店、大使館、領事館、入境處或國際組織" },
      { code: "h06", slug: "long_route", en: "a long-distance transport route or major-journey place", zh: "長途交通路線或重大旅程的地方" },
    ] },
  10: { setting_en: "career, status, reputation, authority, boss, management, mother, profit, achievement", setting_zh: "事業、地位、名聲、權威、上司、管理、母親、利潤、成就",
    ...
    related: [
      { code: "h01", slug: "company_office", en: "workplace, company office, headquarters, executive floor, manager's office, boardroom, government-leadership office or professional institution", zh: "工作場所、公司辦公室、總部、行政樓層、經理室、會議室、政府領導辦公室或專業機構" },
      { code: "h02", slug: "public_reputation", en: "a public-facing place of reputation, recognition, achievement, promotion, awards or official responsibility", zh: "與名聲、認可、成就、晉升、頒獎或正式責任相關的對外場所" },
      { code: "h03", slug: "strategy_area", en: "a business-development, sales, profit, strategy, leadership or decision-making area", zh: "業務發展、銷售、利潤、策略、領導或決策區" },
      { code: "h04", slug: "authority_place", en: "the boss's, supervisor's, director's, public authority's or mother's place", zh: "上司、主管、董事、公權力或母親的地方" },
      { code: "h05", slug: "public_platform", en: "a formal event, conference, ceremony, public platform or place where professional standing is displayed", zh: "正式活動、會議、典禮、公開平台或展示專業地位的地方" },
    ] },
  11: { setting_en: "friends, social circles, allies, helpers, organisations, associations, unions, hopes and plans", setting_zh: "朋友、社交圈、盟友、幫手、組織、協會、工會、願望與計劃",
    ...
    related: [
      { code: "h01", slug: "social_venue", en: "a friend's home, social gathering place, club, association, society, union office, community group or networking venue", zh: "朋友的家、社交聚會地點、會所、協會、社團、工會辦公室、社區團體或聯誼場地" },
      { code: "h02", slug: "group_space", en: "a team space, group meeting room, volunteer organisation, NGO, professional association or membership venue", zh: "團隊空間、小組會議室、義工組織、非政府組織、專業協會或會員場地" },
      { code: "h03", slug: "community_centre", en: "a café, event venue, party space, shared hobby location or community centre", zh: "咖啡店、活動場地、派對空間、共同興趣地點或社區中心" },
      { code: "h04", slug: "online_community", en: "online-community equipment or a group communications area only for a digital item or account", zh: "只針對數碼物品或帳戶：網上社群設備或群組通訊區" },
      { code: "h05", slug: "ally_space", en: "a helper's, supporter's, colleague's or ally's space", zh: "幫手、支持者、同事或盟友的空間" },
    ] },
  12: { setting_en: "secrecy, concealed matters, confinement, isolation, restriction, hospitals, monasteries, hidden enemies, self-undoing, difficulty recovering what is lost", setting_zh: "隱秘、隱藏事務、囚禁、隔離、限制、醫院、修道院、暗中的敵人、自我破壞、難以尋回遺失之物",
    ...
    related: [
      { code: "h01", slug: "institution_isolated", en: "hospital, care institution, retreat, monastery, prison, detention-restricted area or isolated room", zh: "醫院、護理機構、靜修所、修道院、監獄、拘留限制區或隔離房間" },
      { code: "h02", slug: "locked_hidden", en: "a locked room, inaccessible storage, concealed compartment, back room, private archive, hidden cupboard or place not normally entered", zh: "上鎖房間、難以進入的收納、隱藏間格、後房、私人檔案、隱藏櫃或不常進入的地方" },
      { code: "h03", slug: "sealed_beneath", en: "behind furniture, inside another container, beneath stored items or in a sealed bag-box or mixed into forgotten storage", zh: "傢俬後方、另一容器內、堆放物品之下，或封好的袋盒中，或混入被遺忘的收納" },
      { code: "h04", slug: "deliberately_hidden", en: "a place where the item was deliberately hidden, accidentally enclosed, removed from circulation or left behind without awareness", zh: "物品被刻意收藏、意外封入、移離流通或在無意識下留下的地方" },
      { code: "h05", slug: "lost_property", en: "a lost-property office, institutional storage, long-term storage or place controlled by others and hard to access", zh: "失物認領處、機構儲存、長期儲存，或由他人控制而難以到達的地方" },
      { code: "h06", slug: "hard_to_recover", en: "a location genuinely difficult to identify or recover from", zh: "真正難以辨認或尋回的位置" },
    ] },
});

/* ---- Location wire-code invariants (reviewer follow-up) ---- */
// Map a place list to its permanent { code -> global-id } pairs, using the STORED code (never the
// array index). Exposed so a reorder/reverse test can prove codes are position-independent.
export function locationCodeGidPairs(kind: "planet" | "house" | "element", id: string, places: readonly LocPlace[]): Record<string, string> {
  const out: Record<string, string> = {};
  const gid = (slug: string) => kind === "planet" ? `planet.${id}.related.${slug}` : kind === "house" ? `house.${id}.related.${slug}` : `element.${id.toLowerCase()}.${slug}`;
  for (const p of places) out[p.code] = gid(p.slug);
  return out;
}
// Every code is a unique, <=3-char, correctly-prefixed wire code within its bank list. Enforced at
// module load so a reorder / insert / typo in the controlled data fails fast (not silently).
function assertLocationBankCodes(prefix: "p" | "h" | "e", id: string, places: readonly LocPlace[]): void {
  const seen = new Set<string>();
  const re = new RegExp(`^${prefix}\\d\\d$`);
  for (const p of places) {
    if (!re.test(p.code)) throw new Error(`Dice v5 Location code invalid: ${id}/${p.slug} code="${p.code}" (want ${prefix}NN)`);
    if ([...p.code].length > 3) throw new Error(`Dice v5 Location code too long: ${id} "${p.code}"`);
    if (seen.has(p.code)) throw new Error(`Dice v5 Location code duplicate within bank ${id}: "${p.code}"`);
    seen.add(p.code);
  }
}
export function assertAllLocationCodes(): void {
  for (const [el, t] of Object.entries(ELEMENT_TABLE)) assertLocationBankCodes("e", el, t.places);
  for (const [pl, b] of Object.entries(LOCATION_PLANET_BANK)) assertLocationBankCodes("p", pl, b.related);
  for (const [h, b] of Object.entries(LOCATION_HOUSE_BANK)) assertLocationBankCodes("h", String(h), b.related);
}
assertAllLocationCodes(); // fail-fast at import time
